 ...
 *  Attributes are part of CaseComponents and CaseComponentes build a case. 
 * Note that each CaseComponent must be a Java Bean,
 *  so this class represents a field of a Java Bean (with its getXXX() and setXXX() methods).
 * 
...
public class Attribute {
	 ...
	 * (getClass.getDeclaredField(name)). It is recommended to use the other constructor.
	 */
	 ...
	 *  Of course, the object must be instance of the class that this attribute belongs to.
